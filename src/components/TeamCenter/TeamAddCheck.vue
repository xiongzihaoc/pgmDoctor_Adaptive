    ...
    <div class="addTeamCheck" style="height:85%">
        ...
        <div style="height:100%;overflow:hidden">
            <el-card style="height:100%;padding-top:8%;box-sizing:border-box;">
                <el-form :model="addTeamCheckFrom" label-width="80px">
                    ...
                    <el-form-item label="检测人数" prop="checkNum" style="width: 50%;margin-left: 25%;">
                        <el-input v-model="addTeamCheckFrom.checkNum"></el-input>
                    </el-form-item>
                </el-form>
                <div style="width: 50%;display: flex;margin-left: 25%;">
                    <label class="label_check">检测套餐</label>
                    <div style="height: 52px;position: relative;" v-for="(item,index) in addTeamCheckFrom.paramList" :key="index">
                        <span style="line-height: 52px;background: #409EFF;padding: 5px 10px;border-radius: 10px;color: white;" @click="editorPackages(index)">{{item.name}}</span>
                        <i class="el-icon-error" style="font-size: 20px;position: absolute;right: -5px;top: 5px;" @click="removePackages(index)"></i>
                    </div>
                    <div style="margin-left: 10px;width: 50px;height: 50px;border: #606266 dashed 1px;text-align: center;" @click="addCheckPackage()">
        ...
        <el-dialog
            ...
            <el-form
                ...
                label-width="80px">
                <el-form-item prop="name" label="套餐名称" style="width: 70%;">
                    <el-input v-model="checkPackageFrom.packageName"></el-input>
                </el-form-item>
                <el-form-item prop="packageNames" label="选择套餐" style="width: 70%;">
                    <el-input v-model="checkPackageFrom.packageNames" @focus="selectCheckPackage"></el-input>
      ...
      console.log(this.sheetList);
        ...
        if(this.checkList != null && this.checkList.length > 0){
            for (var i = 0; i < this.checkList.length; i++) {
                ...
                this.checkPackageFrom.package.push(packages);
            }
        }
